  ...
  render() {
    return (
      <div className="container">
        <div className="page-header" id="banner">
          <div className="row">
            <div className="col-lg-12">
              <h1>Foorious/Colibri website template</h1>
            </div>
          </div>
        </div>
    
        <h2 style={{backgroundColor: '#111', color: '#fff', padding: '3px 10px'}}>Navbar</h2>
        ...
        <h2 style={{backgroundColor: '#111', color: '#fff', padding: '3px 10px'}}>Buttons</h2>
        ...
        <h2 style={{backgroundColor: '#111', color: '#fff', padding: '3px 10px'}}>Typography</h2>
        ...
        <div className="bs-docs-section">
          ...
          <h2 style={{backgroundColor: '#111', color: '#fff', padding: '3px 10px'}}>Headings</h2>
          ...
          <h2 style={{backgroundColor: '#111', color: '#fff', padding: '3px 10px'}}>Blockquotes</h2>
        ...
        <h2 style={{backgroundColor: '#111', color: '#fff', padding: '3px 10px'}}>Tables</h2>
        ...
        <h2 style={{backgroundColor: '#111', color: '#fff', padding: '3px 10px'}}>Navs</h2>
        ...
        <h2 style={{backgroundColor: '#111', color: '#fff', padding: '3px 10px'}}>Indicators</h2>
        ...
        <h2 style={{backgroundColor: '#111', color: '#fff', padding: '3px 10px'}}>Progress</h2>
        ...
        <h2 style={{backgroundColor: '#111', color: '#fff', padding: '3px 10px'}}>Containers</h2>
        <div className="bs-docs-section">
        ...
        <h2 style={{backgroundColor: '#111', color: '#fff', padding: '3px 10px'}}>Dialogs</h2>
        <div className="bs-docs-section">
