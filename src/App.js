...
class UIBox extends Component {
  render() {
    ...
    if (this.props.disabled !== undefined) {
      headingStyle.backgroundColor = 'red';
      boxStyle.backgroundColor = '#ff03034f';
      boxStyle.opacity = 0.4;
      boxStyle.borderColor = 'red';
    } else {
      headingStyle.backgroundColor = 'green';
      boxStyle.backgroundColor = '#fff';
      boxStyle.borderColor = 'green';
    }

    return (
      <div style={boxStyle}>
        <h2 style={headingStyle}>{this.props.name}</h2>
        {this.props.children}
      </div>    
    );
  }
...
<HamburgerButton onClick={(e, animationDuration) => {console.log('Animation will last: ' + animationDuration + 'ms')}} />   
        ...
        <UIBox name="Typography" disabled>
          <div className="bs-docs-section">
        ...
        <UIBox name="Indicators" disabled>
          <div className="bs-docs-section">
            <div className="row">
              <div className="col-lg-12">
        ...
        <UIBox name="Containers" disabled>
          <div className="bs-docs-section">
  ...
  <span>Hover me</span>
                      ...
                      <div className="col-6">
                        <Tooltip content={
                          ...
                          <button className="btn">Hover me (JSX)</button>
                        </Tooltip>
